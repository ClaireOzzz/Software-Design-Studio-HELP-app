...
RSpec.describe "/connections", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get api_v1_connections_url, headers: valid_headers, as: :json
  ...
  describe "GET /show" do
    it "renders a successful response" do
      ...
      get api_v1_connection_url(connection), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested connection" do
        connection = Connection.create! valid_attributes
        patch api_v1_connection_url(connection),
  ...
  describe "DELETE /destroy" do
    it "destroys the requested connection" do
      connection = Connection.create! valid_attributes
      expect {
        delete api_v1_connection_url(connection), headers: valid_headers, as: :json
      }.to change(Connection, :count).by(-1)
    end
  end
end

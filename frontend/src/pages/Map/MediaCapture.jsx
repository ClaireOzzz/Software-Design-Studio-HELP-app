          ...
          {imgSrc ?
            <div>
              ...
              <Stack direction="row" alignItems="center" justifyContent="center" spacing={2}>
                ...
                <Button id="detect-button" variant="contained" component="label" startIcon={isLoading ? <CircularProgress color="white" size={20} /> : <FindInPageIcon />} onClick={() => handleDetect()}>
                  {t('maps.detect')}
                </Button>
              </Stack>
            </div>
            ...
            <div style={{ textAlign: 'center', padding: '10px 0' }}>
              <Button id="upload-button" variant="contained" component="label" startIcon={<PhotoCamera />}>
                {t('maps.upload')} 
                <input name="upload" id="upload" hidden accept="image/jpeg, image/png, image/webp" type="file" onChange={handleImage} />
              </Button>
            </div>}
        </div>
      </Container>

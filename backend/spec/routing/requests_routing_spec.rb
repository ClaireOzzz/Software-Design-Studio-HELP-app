...
RSpec.describe Api::V1::RequestsController, type: :routing do
  describe "routing" do
    it "routes to #index" do
      expect(get: "/api/v1/users/1/feed/requests").to route_to({"controller"=>"api/v1/requests", "user_id"=>"1", "action"=>"index"})
      expect(get: "/api/v1/users/1/requests").to route_to({"controller"=>"api/v1/requests", "action"=>"index", "user_id"=>"1"})
    end

    it "routes to #show" do
      expect(get: "/api/v1/users/1/feed/requests/1").to route_to({"controller"=>"api/v1/requests", "action"=>"show", "user_id"=>"1", "id"=>"1"})
      expect(get: "/api/v1/users/1/requests/1").to route_to({"controller"=>"api/v1/requests", "action"=>"show", "id"=>"1", "user_id"=>"1"})
    end


    it "routes to #create" do
      expect(post: "/api/v1/users/1/feed/requests").to route_to({"controller"=>"api/v1/requests", "user_id"=>"1", "action"=>"create"})
    ...
    it "routes to #accept" do
      expect(post: "/api/v1/users/1/feed/requests/1/accept").to route_to({"controller"=>"api/v1/requests", "action"=>"accept", "user_id"=>"1", "id"=>"1"})

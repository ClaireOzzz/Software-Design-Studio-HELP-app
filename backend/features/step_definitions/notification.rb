...
Given /user "(.*)" accepts my request/ do |username|
    step 'I logout'
    step 'I log in as "' + username + '"'
    # step 'I follow "Relatives require place to stay"'
    find(".request", text: /Relatives require place to stay/).click
    step 'I press "Click to Help"'
